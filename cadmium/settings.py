...
# Cuando tengas PostgreSQL corriendo, cambia a la configuración comentada abajo
DATABASES = {
    'default': {
...
# Configuración para PostgreSQL (descomentar cuando tengas PostgreSQL corriendo)
# DATABASES = {
#     'default': {
